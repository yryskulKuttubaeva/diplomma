  ...
  return (
    <footer className="Footer">
      <div className="container">
        ...
        <ul className="ul">
          <li>
            <img className="icon" src={teleImage} alt="tele" />
          </li>
          <li>
            <img className="icon" src={youImage} alt="tele" />
          </li>
          <li>
            <img className="icon" src={twitterImage} alt="tele" />
          </li>
          <li>
            <img className="icon" src={faceImage} alt="tele" />
          </li>
          <li>
            <img className="icon" src={gitImage} alt="tele" />
          </li>
          <li>
            <img className="icon" src={instaImage} alt="tele" />
          </li>
        </ul>
      </div>
    </footer>
